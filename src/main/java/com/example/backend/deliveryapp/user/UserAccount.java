package com.example.backend.deliveryapp.user;

import com.example.backend.deliveryapp.root.AuditableEntity;
...
public class UserAccount extends AuditableEntity {
    ...
    public UserAccount(String username, String email, String phoneNum) {
