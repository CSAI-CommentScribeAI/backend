...
public class MenuOptionController {
    ...
    public ResponseEntity<ResponseDTO> insertMenuOption(@RequestBody MenuOptionDTO menuOptionDTO) {
        MenuOptionDTO createdMenuOption = menuOptionService.insertMenuOption(menuOptionDTO);
    ...
    public ResponseEntity<ResponseDTO> updateMenuOption(@PathVariable Long id, @RequestBody MenuOptionDTO menuOptionDTO) {
        MenuOptionDTO updatedMenuOption = menuOptionService.updateMenuOption(id, menuOptionDTO);
    ...
    public ResponseEntity<ResponseDTO> deleteMenuOption(@PathVariable Long id) {
